...
(function (factory) {
    ...
    function RenderDayRow(type, style) {
        if (type == '--')
    ...
    */
            ...
            if (this.view.type == 'agendaDay') {
                ...
                if (displayType == "Installation") {
                    ...
                    retValue += '<tbody>' +
                        ...
                        RenderDayRow('Min', dayIDs[cell.start.day()]) +
                        RenderDayRow('Max', dayIDs[cell.start.day()]) +
    ...
    var AgendaView = View.extend({
        ...
        headIntroHtml: function () {
            ...
            if (this.opt('weekNumbers')) {
                ...
                return '<th class="fc-axis ' + this.widgetHeaderClass + '" ' + this.axisStyleAttr() + ' style="width:120px;"></th>';
            }
        },
    ...
    fcViews.agenda = {
        ...
        defaults: {
            allDaySlot: true,
            allDayText: 'Planned Items',//'all-day',
