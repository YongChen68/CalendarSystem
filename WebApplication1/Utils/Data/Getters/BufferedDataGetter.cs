...
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL],[F68SLMin], [F68VS],[F68VSMin],[BatchNo], [Transom], [Sidelite], [SingleDoor], [DoubleDoor], [CompleteDate], [HighRiskFlag], [CustomFlag],case when [M2000Icon] = 'Yes' then 1 else 0 end as M2000Icon, Branch_display as Branch, [CardinalOrderedDate], JobType, CurrentStateName
...
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin], [SimpleWindows] as Simple, [ComplexWindows] as Complex, [OverSize] as Over_Size, [Arches], [Rakes], [CustomWindows] as Customs,
...
[PaintIcon],[WindowIcon],[DoorIcon],
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin],[BatchNo], [Transom], [Sidelite], [SingleDoor], [DoubleDoor], [CompleteDate], [HighRiskFlag], [CustomFlag],case when [M2000Icon] = 'Yes' then 1 else 0 end as M2000Icon, Branch_display as Branch, [CardinalOrderedDate], JobType, CurrentStateName, [SimpleWindows] as Simple, [ComplexWindows] as Complex, [OverSize] as Over_Size, [Arches], [Rakes], [CustomWindows] as Customs
from PlantProduction p with(nolock,noexpand) 
...
[PaintIcon],[WindowIcon],[DoorIcon],
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin], [Transom], [Sidelite], [SingleDoor], [DoubleDoor],[BatchNo], [CompleteDate], [HighRiskFlag], [CustomFlag],case when [M2000Icon] = 'Yes' then 1 else 0 end as M2000Icon, Branch_display as Branch, [CardinalOrderedDate], JobType, CurrentStateName, [SimpleWindows] as Simple, [ComplexWindows] as Complex, [OverSize] as Over_Size, [Arches], [Rakes], [CustomWindows] as Customs
from PlantProduction p with(nolock,noexpand) 
