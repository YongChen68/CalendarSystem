...
namespace CalendarSystem.Utils.Data
{
    public class BufferedDataGetter : IGetter
    {
        ...
        private string GetInstallationSQL()
        {
          ...
          SELECT  win.Number_1 as windows	 , win.Number_1 as TotalWindows, door.Number_1 as doors	 ,  door.Number_1 as TotalDoors, 
others.Number_1 as others	, others.Number_1 as other, dates.ScheduledDate,ActionItemId as id,0 as SalesAmmount,
