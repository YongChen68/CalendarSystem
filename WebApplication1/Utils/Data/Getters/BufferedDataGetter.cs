...
namespace CalendarSystem.Utils.Data
{
    public class BufferedDataGetter : IGetter
    {
        ...
        private string GetInstallationSQL()
        {
          ...
          SELECT  win.Number_1 as windows	 , win.Number_1 as TotalWindows, door.Number_1 as doors	 ,  door.Number_1 as TotalDoors, '' as SubTradeFlag,0 as HazardousBudgetedLBR,dates.EndTime,
0 as MinAvailable,0 as SalesTarget, null as WoodDropOffDate,'No' as HomeDepotJob, 0 as AgeOfHome,ReturnTripReason, '' as ResourceID, '' as ParentRecordId,
others.Number_1 as others	, others.Number_1 as other, dates.ScheduledDate,dates.ScheduledDate as StartScheduleDate,dates.ScheduledDate as EndScheduleDate,dates.EndTime,'Yes' as allDay,
...
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL],[F68SLMin], [F68VS],[F68VSMin],  [F29CMMin],[F29CAMin],[F26CAMin],[F27DSMin],[BatchNo], [Transom], [Sidelite], [SingleDoor], [DoubleDoor], [CompleteDate], [HighRiskFlag], [CustomFlag],case when [M2000Icon] = 'Yes' then 1 else 0 end as M2000Icon, Branch_display as Branch, [CardinalOrderedDate], JobType, CurrentStateName
...
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin],  [F29CMMin],[F29CAMin],[F26CAMin],[F27DSMin], [SimpleWindows] as Simple, [ComplexWindows] as Complex, [OverSize] as Over_Size, [Arches], [Rakes], [CustomWindows] as Customs,
...
[PaintIcon],[WindowIcon],[DoorIcon],
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin],  [F29CMMin],[F29CAMin],[F26CAMin],[F27DSMin],[BatchNo], [Transom], [Sidelite], [SingleDoor], [DoubleDoor], [CompleteDate], [HighRiskFlag], [CustomFlag],case when [M2000Icon] = 'Yes' then 1 else 0 end as M2000Icon, Branch_display as Branch, [CardinalOrderedDate], JobType, CurrentStateName, [SimpleWindows] as Simple, [ComplexWindows] as Complex, [OverSize] as Over_Size, [Arches], [Rakes], [CustomWindows] as Customs
from PlantProduction p with(nolock,noexpand) 
...
[PaintIcon],[WindowIcon],[DoorIcon],
case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder,[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin],   [F29CMMin],[F29CAMin],[F26CAMin],[F27DSMin],[Transom], [Sidelite], [SingleDoor], [DoubleDoor],[BatchNo], [CompleteDate], [HighRiskFlag], [CustomFlag],case when [M2000Icon] = 'Yes' then 1 else 0 end as M2000Icon, Branch_display as Branch, [CardinalOrderedDate], JobType, CurrentStateName, [SimpleWindows] as Simple, [ComplexWindows] as Complex, [OverSize] as Over_Size, [Arches], [Rakes], [CustomWindows] as Customs
from PlantProduction p with(nolock,noexpand) 
