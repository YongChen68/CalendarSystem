...
x.doors, x.windows, 'true' as allDay,[PaintIcon],[WindowIcon],[DoorIcon], [M2000Icon], [FlagOrder],[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68SLMin], [F68VSMin],
...
[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin], [Transom], [Sidelite], [SingleDoor], [DoubleDoor], [BatchNo], Branch_display as Branch, JobType, 
...
[F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin], [Transom], [Sidelite], [SingleDoor], [DoubleDoor],  [BatchNo], Branch, JobType, 
...
[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin], [Transom], [Sidelite], 
...
x.doors, x.windows, /*case when datediff(day, startDateTime, x.endDateTime) > 0 or datepart(hour, x.startDateTime) = 0 then 'true' else 'false' end*/ 'true' as allDay,[PaintIcon],[WindowIcon],[DoorIcon], [M2000Icon], [FlagOrder],[TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin], [Transom], [Sidelite], [SingleDoor], [DoubleDoor],  [BatchNo], Branch, JobType, [CardinalOrderedDate], [CompleteDate], [HighRiskFlag], [CustomFlag], CurrentStateName,NumberOfPatioDoors, Simple, Complex, Over_Size, [Arches], [Rakes], Customs
from (select p.ActionItemId as id, p.WorkOrderNumber as title, '' as [description], 
...
case when p.NumberofWindows is null then 0 else p.NumberofWindows end as windows, '' as type, [PaintIcon],[WindowIcon],[DoorIcon],case when [M2000Icon] = 'Yes' then 1 else 0 end as M2000Icon,case when [FlagOrder] = 'Yes' then 1 else 0 end as FlagOrder, [TotalBoxQty], [TotalGlassQty], [TotalPrice], [TotalLBRMin], [F6CA], [F27DS], [F27TS], [F27TT], [F29CA], [F29CM], [F52PD], [F68CA], [F68SL], [F68VS],[F68SLMin], [F68VSMin], [Transom], [Sidelite], [SingleDoor], [DoubleDoor], [BatchNo], Branch_display as Branch, JobType, [CardinalOrderedDate], [CompleteDate], [HighRiskFlag], [CustomFlag], CurrentStateName, [SimpleWindows] as Simple, [ComplexWindows] as Complex, [OverSize] as Over_Size, [Arches], [Rakes], [CustomWindows] as Customs 
 from PlantProduction p with(nolock,noexpand) 
